...
/***/ function(module, exports, __webpack_require__) {
	...
	_localStorage2.default.set('nome', 'rangel netto');
	console.log(_localStorage2.default.get('nome'));
	console.log(_localStorage2.default.setObject('oloko', { id: 15, name: 'no name guy 2 ss' }));
...
/***/ function(module, exports) {
	...
	module.exports = "\n<div id=\"app\">\n    <header>\n\n    </header>\n\n    <main>\n       <router-view></router-view>\n    </main>\n\n    <footer class=\"page-footer\">\n        <div class=\"footer-copyright\">\n            <div class=\"container\">\n                © {{ year }} <a class=\"grey-text text-lighten-4\" href=\"https://github.com/flashimxd\"> Rangel N. - Code Education</a>\n            </div>\n        </div>\n    </footer>\n\n</div>\n";
	...
	exports.default = {
	    ...
	    methods: {
	        login: function login() {
	            ...
	            _resources.Jwt.accessToken(this.user.email, this.user.password).then(function (response) {
